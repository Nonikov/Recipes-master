...
var RecipeEditComponent = /** @class */ (function () {
    function RecipeEditComponent(dataService, router, activeRoute) {
    ...
    RecipeEditComponent.prototype.ngOnInit = function () {
        ...
        if (this.id)
            this.dataService.getRecipe(this.id)
                ...
                _this.recipe = data;
                if (_this.recipe != null)
                    _this.loaded = true;
            });
    };
    RecipeEditComponent.prototype.save = function () {
        var _this = this;
        this.dataService.updateRecipe(this.recipe).subscribe(function (data) { return _this.router.navigateByUrl("/"); });
    };
